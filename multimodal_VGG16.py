...
for subset in range(0,5):
    ...
    base_VGG16=VGG16(weights='imagenet', include_top=False, input_shape=(img_rows, img_cols, img_channel))
    
    output_shared = base_VGG16(x)
    ...
    model_all.save('MTL_VGG16_clinical_%d.h5' % subset)
    ...
    f = open('results_MTL_VGG16_clinical.txt', 'a+')
    f.write('\n\nNCI_%d:' % subset +
